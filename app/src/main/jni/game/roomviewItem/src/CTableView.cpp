...
#define LOG_TAG "CTableView"

#include <assert.h>
#include <string.h>
#include "../../datatype/CTableView.h"
#include "../../../log.h"

tagTableState::tagTableState() : bPass(false),bPlaying(false),wTableID(INVALID_TABLE),wSitCount(0),wChairCount(10),dwTableMasterID(0)
{
