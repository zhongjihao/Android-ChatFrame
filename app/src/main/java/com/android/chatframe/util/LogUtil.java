...
public class LogUtil {
    public static final String BUGLE_TAG = "ChatFrameApp";
    public static final String PROFILE_TAG = "ChatFrameAppProf";
    public static final String BUGLE_DATABASE_TAG = "ChatFrameAppDb";
    public static final String BUGLE_DATABASE_PERF_TAG = "ChatFrameAppDbPerf";
    public static final String BUGLE_DATAMODEL_TAG = "ChatFrameAppDataModel";
    public static final String BUGLE_IMAGE_TAG = "ChatFrameAppImage";
    public static final String BUGLE_NOTIFICATIONS_TAG = "ChatFrameAppNotif";
    public static final String BUGLE_WIDGET_TAG = "ChatFrameAppWidget";
