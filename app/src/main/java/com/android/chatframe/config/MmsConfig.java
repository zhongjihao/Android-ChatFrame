...
import com.android.chatframe.util.SafeAsyncTask;
...
public class MmsConfig {
    ...
    private static final Map<String, String> sKeyTypeMap = new HashMap<String, String>();
    static {
    ...
    private static final Map<Integer, MmsConfig> sSubIdToMmsConfigMap = new HashMap<Integer, MmsConfig>();
    // The fallback values
    private static final MmsConfig sFallback =
            new MmsConfig(-1, new Bundle());
    ...
    public static MmsConfig get(final int subId) {
        synchronized (sSubIdToMmsConfigMap) {
            final MmsConfig mmsConfig = sSubIdToMmsConfigMap.get(subId);
            if (mmsConfig == null) {
    ...
    public static synchronized void load() {
        ...
        if (OsUtil.isAtLeastL_MR1()) {
            ...
            final Bundle values = loader.get(-1);
            addMmsConfig(new MmsConfig(-1,values));
        }
    }
